...
extern double g_scale_factor; //搜索窗口比例

extern int g_min_neighbors; //最小相邻矩形

extern int g_flags;  //是否做边缘检测 ，0表示做，-1表示不做

extern int g_min_size_w;  //检测窗口最小宽度

extern int g_min_size_h;   //检测窗口最小高度
